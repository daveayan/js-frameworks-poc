...
var ReportDifferentiationResources = React.createClass({displayName: "ReportDifferentiationResources",
  render : function() {
    var differentiationResourceAsHtml = [];
    var cs = this.props.currentStandard;
    this.props.differentiationResources[cs].forEach(function(oneResource) {
      if(oneStandard !== cs) {
        differentiationResourceAsHtml.push(React.createElement(AssetThumbnail, {standard: oneResource, key: oneResource}))
      }
    });
    return (
      React.createElement("div", {className: "container clearfix", id: "differentiation-container"}, 
      	React.createElement("div", {className: "differentiation-title"}, "Differentiation Resource"), 
      	React.createElement("div", {className: "resource"}, this.props.differentiationResources)
      )
    )
  }
});
...
var ReportStandardsWidget = React.createClass({displayName: "ReportStandardsWidget",
  ...
  componentWillMount: function() {
    console.log("ReportStandardsWidget componentWillMount");
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {id: "pageContent"}, 
        ...
        React.createElement(ReportDifferentiationResources, {
