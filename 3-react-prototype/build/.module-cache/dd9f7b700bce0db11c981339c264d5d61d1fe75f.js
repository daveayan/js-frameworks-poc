  ...
  render: function() {
    ...
    return (
      ...
      React.createElement(ReportStudentList, {allStudents: this.props.allStudents}), 
			...
			// 	<div class="row">
			// 		<div class="col-md-7" id="pogReportGraph">
			// 			<div report-graph current-student="currentStudent"></div>
			// 		</div>
			// 		<div class="col-md-5">
			// 			<div standards current-standard="currentStandard" available-standards="availableStandards"></div>
			// 			<div standards-exposures></div>
			// 		</div>
			// 	</div>
			// </div>
			// <div differentiation-resources list-of-differentiation-assets="differentiationResources[currentStandard]"></div>
      // </div>
      );
    }
});
