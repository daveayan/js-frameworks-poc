var ReportGraphSingleStudent = React.createClass({displayName: "ReportGraphSingleStudent",
  render: function() {
    var selectStudent = function( msg, data ){
      console.log( msg, data );
    };
    var token = PubSub.subscribe( 'SELECT_STUDENT', selectStudent );
...
var ReportSingleStudent = React.createClass({displayName: "ReportSingleStudent",
  handleClick: function(event, data) {
    console.log("Clicked");
    PubSub.publish( 'SELECT_STUDENT', data );
  },
  render: function() {
    console.log(this.props.student);
    return (
      React.createElement("div", {className: "item"}, 
        React.createElement("div", {className: "evaluation-student", onClick: this.handleClick(this.props.student)}, 
...
React.render(React.createElement(ReportUI, {allStudents: allStudents, currentStudent: currentStudent}), document.getElementById("pageContent123"));
